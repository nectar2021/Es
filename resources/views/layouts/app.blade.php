...
<head>
  ...
  <!-- SEO Meta Tags -->
  <title>Finder | Real Estate - Homepage</title>
  ...
  <link rel="preload" href="{{ asset('frontend/assets/fonts/inter-variable-latin.woff2') }}" as="font" type="font/woff2"
    crossorigin="">

  <!-- Font icons -->
  <link rel="preload" href="{{ asset('frontend/assets/icons/finder-icons.woff2') }}" as="font" type="font/woff2"
    crossorigin="">
  <link rel="stylesheet" href="{{ asset('frontend/assets/icons/finder-icons.min.css') }}">
...
<body>
  ...
  <div class="offcanvas offcanvas-end" id="customizer" tabindex="-1">
    ...
    <div class="offcanvas-body">
      ...
      <div class="customizer-collapse collapse" id="customizerCode">
        <div class="nav mb-3">
          <a class="nav-link position-relative fs-base p-0" href=".customizer-collapse" data-bs-toggle="collapse"
            ...
            <li class="nav-item dropdown py-lg-2 me-lg-n1 me-xl-0">
              ...
              <ul class="dropdown-menu">
                <li class="hover-effect-opacity px-2 mx-n2">
                  <a class="dropdown-item d-block mb-0" href="{{ url('home-real-estate.html') }}">
                    ...
                    <div
                      ...
                      <img class="position-relative z-2 d-none-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/real-estate-light.jpg') }}" alt="Real Estate Demo">
                      <img class="position-relative z-2 d-none d-block-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/real-estate-dark.jpg') }}" alt="Real Estate Demo">
                ...
                <li class="hover-effect-opacity px-2 mx-n2">
                  <a class="dropdown-item d-block mb-0" href="{{ url('home-cars.html') }}">
                    ...
                    <div
                      ...
                      style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
                      <img class="position-relative z-2 d-none-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/cars-light.jpg') }}" alt="Cars Demo">
                      <img class="position-relative z-2 d-none d-block-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/cars-dark.jpg') }}" alt="Cars Demo">
                      <span class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
                        style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
                      <span
                        class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none d-block-dark"
                ...
                <li class="hover-effect-opacity px-2 mx-n2">
                  <a class="dropdown-item d-block mb-0" href="{{ url('home-contractors.html') }}">
                    ...
                    <div
                      ...
                      style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
                      <img class="position-relative z-2 d-none-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/contractors-light.jpg') }}" alt="Contractors Demo">
                      <img class="position-relative z-2 d-none d-block-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/contractors-dark.jpg') }}" alt="Contractors Demo">
                      <span class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
                        style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
                      <span
                        class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none d-block-dark"
                ...
                <li class="hover-effect-opacity px-2 mx-n2">
                  <a class="dropdown-item d-block mb-0" href="home-doctors.html">
                    ...
                    <div
                      ...
                      style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
                      <img class="position-relative z-2 d-none-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/doctors-light.jpg') }}" alt="Doctors Demo">
                      <img class="position-relative z-2 d-none d-block-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/doctors-dark.jpg') }}" alt="Doctors Demo">
                      <span class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
                        style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
                      <span
                        class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none d-block-dark"
                ...
                <li class="hover-effect-opacity px-2 mx-n2">
                  <a class="dropdown-item d-block mb-0" href="{{ url('home-events.html') }}">
                    ...
                    <div
                      ...
                      style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
                      <img class="position-relative z-2 d-none-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/events-light.jpg') }}" alt="Events Demo">
                      <img class="position-relative z-2 d-none d-block-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/events-dark.jpg') }}" alt="Events Demo">
                      <span class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
                        style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
                      <span
                        class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none d-block-dark"
                ...
                <li class="hover-effect-opacity px-2 mx-n2">
                  <a class="dropdown-item d-block mb-0" href="{{ url('home-city-guide.html') }}">
                    ...
                    <div
                      ...
                      style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
                      <img class="position-relative z-2 d-none-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/city-guide-light.jpg') }}" alt="City Guide Demo">
                      <img class="position-relative z-2 d-none d-block-dark"
                        src="{{ asset('frontend/assets/img/mega-menu/city-guide-dark.jpg') }}" alt="City Guide Demo">
                      <span class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
                        style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
                      <span
                        class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none d-block-dark"
                    ...
                    <div class="d-flex flex-column flex-lg-row gap-4">
                      ...
                      <div style="min-width: 190px">
                        ...
                        <ul class="nav flex-column gap-2 mt-0">
                          <li class="pt-1">
                            <a class="nav-link hover-effect-underline d-inline fw-normal p-0"
                              href="listings-side-filters-city-guide.html">Listings with Side Filters</a>
                          </li>
                          <li class="pt-1">
                            <a class="nav-link hover-effect-underline d-inline fw-normal p-0"
                              href="listings-top-filters-city-guide.html">Listings with Top Filters</a>
                          </li>
                          <li class="pt-1">
                            <a class="nav-link hover-effect-underline d-inline fw-normal p-0"
                      ...
                      <div style="min-width: 190px">
                        ...
                        <ul class="nav flex-column gap-2 mt-0">
                          <li class="pt-1">
                            <a class="nav-link hover-effect-underline d-inline fw-normal p-0" href="add-car.html">Add
                              (Sell) Car Page</a>
                          </li>
                        </ul>
                      </div>
          ...
          <div style="width: 768px">
            ...
            <div class="position-relative overflow-hidden">
              ...
              <div class="ratio bg-body-tertiary rounded overflow-hidden"
                ...
                <img src="{{ asset('frontend/assets/img/home/real-estate/hero/01.jpg') }}" alt="Image">
              </div>
            </div>
          </div>
          <div style="width: 306px">
            <div class="position-relative overflow-hidden">
              ...
              <div class="ratio bg-info rounded overflow-hidden" style="--fn-aspect-ratio: calc(443 / 306 * 100%)">
                <img src="{{ asset('frontend/assets/img/home/real-estate/hero/02.jpg') }}" alt="Image">
              </div>
            </div>
          </div>
          <div style="width: 438px">
            ...
            <div class="position-relative overflow-hidden">
              ...
              <div class="ratio bg-body-tertiary rounded overflow-hidden"
                ...
                <img src="{{ asset('frontend/assets/img/home/real-estate/hero/03.jpg') }}" alt="Image">
              </div>
            </div>
          </div>
        </div>
            ...
            <article class="card hover-effect-scale bg-primary-subtle border-0 overflow-hidden text-center">
              ...
              <div class="card-footer d-flex flex-column align-items-center gap-4 gap-sm-5 bg-transparent border-0 p-0">
                ...
                <div class="ratio hover-effect-target mt-3 mt-sm-0" style="--fn-aspect-ratio: calc(216 / 416 * 100%)">
                  <img src="{{ asset('frontend/assets/img/home/real-estate/categories/01.png') }}" alt="Image">
                </div>
              </div>
            </article>
          </div>
          ...
          <div class="swiper-slide">
            <article class="card hover-effect-scale bg-info border-0 overflow-hidden text-center">
              ...
              <div class="card-footer d-flex flex-column align-items-center gap-4 gap-sm-5 bg-transparent border-0 p-0">
                ...
                <div class="ratio hover-effect-target mt-3 mt-sm-0" style="--fn-aspect-ratio: calc(216 / 416 * 100%)">
                  <img src="{{ asset('frontend/assets/img/home/real-estate/categories/02.png') }}" alt="Image">
                </div>
              </div>
            </article>
          </div>
            ...
            <article class="card hover-effect-opacity h-100">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper="{
                  ...
                  <a class="swiper-wrapper" href="{{ url('single-entry-real-estate.html') }}">
                    <div class="swiper-slide">
                      <div class="ratio d-block" style="--fn-aspect-ratio: calc(248 / 362 * 100%)">
                        <img src="{{ asset('frontend/assets/img/listings/real-estate/01.jpg') }}" alt="Image">
              ...
              <div class="card-body p-3">
                ...
                <h3 class="fs-sm fw-normal text-body mb-2">
                  <a class="stretched-link text-body" href="single-entry-real-estate.html">40 S 9th St, Brooklyn, NY
                    11249</a>
                </h3>
          ...
          <div class="swiper-slide h-auto">
            <article class="card hover-effect-opacity h-100">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper="{
                  ...
                  <a class="swiper-wrapper" href="{{ url('single-entry-real-estate.html') }}">
                    <div class="swiper-slide">
                      <div class="ratio d-block" style="--fn-aspect-ratio: calc(248 / 362 * 100%)">
                        <img src="{{ asset('frontend/assets/img/listings/real-estate/04.jpg') }}" alt="Image">
                        <span class="position-absolute top-0 start-0 w-100 h-100 z-1"
                          style="background: linear-gradient(180deg, rgba(0,0,0, 0) 0%, rgba(0,0,0, .11) 100%)"></span>
                      </div>
                    </div>
              ...
              <div class="card-body p-3">
                ...
                <h3 class="fs-sm fw-normal text-body mb-2">
                  <a class="stretched-link text-body" href="single-entry-real-estate.html">67-04 Myrtle Ave Glendale, NY
                    11385</a>
                </h3>
          ...
          <div class="swiper-slide h-auto">
            <article class="card hover-effect-opacity h-100">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper="{
                  ...
                  <a class="swiper-wrapper" href="{{ url('single-entry-real-estate.html') }}">
                    <div class="swiper-slide">
                      <div class="ratio d-block" style="--fn-aspect-ratio: calc(248 / 362 * 100%)">
                        <img src="{{ asset('frontend/assets/img/listings/real-estate/06.jpg') }}" alt="Image">
                        <span class="position-absolute top-0 start-0 w-100 h-100 z-1"
                          style="background: linear-gradient(180deg, rgba(0,0,0, 0) 0%, rgba(0,0,0, .11) 100%)"></span>
                      </div>
                    </div>
              ...
              <div class="card-body p-3">
                ...
                <h3 class="fs-sm fw-normal text-body mb-2">
                  <a class="stretched-link text-body" href="single-entry-real-estate.html">929 Hart St, Brooklyn, NY
                    11237</a>
                </h3>
          ...
          <div class="swiper-slide h-auto">
            <article class="card hover-effect-opacity h-100">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper="{
                  ...
                  <a class="swiper-wrapper" href="{{ url('single-entry-real-estate.html') }}">
                    <div class="swiper-slide">
                      <div class="ratio d-block" style="--fn-aspect-ratio: calc(248 / 362 * 100%)">
                        <img src="{{ asset('frontend/assets/img/listings/real-estate/07.jpg') }}" alt="Image">
                        <span class="position-absolute top-0 start-0 w-100 h-100 z-1"
                          style="background: linear-gradient(180deg, rgba(0,0,0, 0) 0%, rgba(0,0,0, .11) 100%)"></span>
                      </div>
                    </div>
              ...
              <div class="card-body p-3">
                ...
                <h3 class="fs-sm fw-normal text-body mb-2">
                  <a class="stretched-link text-body" href="single-entry-real-estate.html">123 Bedford Avenue, Brooklyn,
                    NY 11211</a>
                </h3>
          ...
          <div class="swiper-slide h-auto">
            <article class="card hover-effect-opacity h-100">
              <div class="card-img-top position-relative bg-body-tertiary overflow-hidden">
                <div class="swiper z-2" data-swiper="{
                  ...
                  <a class="swiper-wrapper" href="{{ url('single-entry-real-estate.html') }}">
                    <div class="swiper-slide">
                      <div class="ratio d-block" style="--fn-aspect-ratio: calc(248 / 362 * 100%)">
                        <img src="{{ asset('frontend/assets/img/listings/real-estate/02.jpg') }}" alt="Image">
                        <span class="position-absolute top-0 start-0 w-100 h-100 z-1"
                          style="background: linear-gradient(180deg, rgba(0,0,0, 0) 0%, rgba(0,0,0, .11) 100%)"></span>
                      </div>
                    </div>
              ...
              <div class="card-body p-3">
                ...
                <h3 class="fs-sm fw-normal text-body mb-2">
                  <a class="stretched-link text-body" href="single-entry-real-estate.html">517 82nd St, Brooklyn, NY
                    11209</a>
                </h3>
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4 g-md-3 g-xl-4">
          <div class="col">
            ...
            <article class="hover-effect-scale position-relative bg-body-tertiary rounded overflow-hidden h-100">
              ...
              <img src="{{ asset('frontend/assets/img/listings/real-estate/featured/01.jpg') }}"
          ...
          <div class="col vstack gap-4 gap-md-3 gap-xl-4">
            ...
            <article class="hover-effect-scale position-relative bg-body-tertiary rounded overflow-hidden">
              ...
              <img src="{{ asset('frontend/assets/img/listings/real-estate/featured/02.jpg') }}"
                class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Image">
              <div class="ratio d-none d-sm-block" style="--fn-aspect-ratio: calc(307 / 636 * 100%)"></div>
              <div class="ratio d-sm-none" style="--fn-aspect-ratio: calc(410 / 636 * 100%)"></div>
              <div class="position-absolute top-0 start-0 w-100 h-100 z-1 p-3">
            ...
            <article class="hover-effect-scale position-relative bg-body-tertiary rounded overflow-hidden">
              ...
              <img src="{{ asset('frontend/assets/img/listings/real-estate/featured/03.jpg') }}"
                class="hover-effect-target position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Image">
              <div class="ratio d-none d-sm-block" style="--fn-aspect-ratio: calc(307 / 636 * 100%)"></div>
              <div class="ratio d-sm-none" style="--fn-aspect-ratio: calc(410 / 636 * 100%)"></div>
              <div class="position-absolute top-0 start-0 w-100 h-100 z-1 p-3">
        ...
        <div class="row align-items-center justify-content-center justify-content-lg-start py-lg-3">
          <div class="col-10 col-sm-8 col-md-7 col-lg-5 offset-lg-1 pb-3 pb-lg-0 mb-3 mb-lg-0">
            <div class="ratio mx-auto mx-lg-0" style="max-width: 479px; --fn-aspect-ratio: calc(300 / 479 * 100%)">
              <img src="{{ asset('frontend/assets/img/home/real-estate/building.png') }}" alt="Image">
            </div>
          </div>
        ...
        <div class="swiper-wrapper">
            ...
            <article class="card h-100 hover-effect-scale bg-transparent">
              <div class="card-img-top bg-body-tertiary overflow-hidden">
                <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(230 / 306 * 100%)">
                  <img src="{{ asset('frontend/assets/img/home/real-estate/cities/01.jpg') }}" alt="Image">
                </div>
              </div>
          ...
          <div class="swiper-slide h-auto">
            <article class="card h-100 hover-effect-scale bg-transparent">
              <div class="card-img-top bg-body-tertiary overflow-hidden">
                <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(230 / 306 * 100%)">
                  <img src="{{ asset('frontend/assets/img/home/real-estate/cities/02.jpg') }}" alt="Image">
                </div>
              </div>
              <div class="card-body text-center p-3">
                <h3 class="h5 mb-0">
          ...
          <div class="swiper-slide h-auto">
            <article class="card h-100 hover-effect-scale bg-transparent">
              <div class="card-img-top bg-body-tertiary overflow-hidden">
                <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(230 / 306 * 100%)">
                  <img src="{{ asset('frontend/assets/img/home/real-estate/cities/03.jpg') }}" alt="Image">
                </div>
              </div>
              <div class="card-body text-center p-3">
                <h3 class="h5 mb-0">
          ...
          <div class="swiper-slide h-auto">
            <article class="card h-100 hover-effect-scale bg-transparent">
              <div class="card-img-top bg-body-tertiary overflow-hidden">
                <div class="ratio hover-effect-target" style="--fn-aspect-ratio: calc(230 / 306 * 100%)">
                  <img src="{{ asset('frontend/assets/img/home/real-estate/cities/06.jpg') }}" alt="Image">
                </div>
              </div>
              <div class="card-body text-center p-3">
                <h3 class="h5 mb-0">
              ...
              <div class="card-body text-center p-3">
                <h3 class="h5 mb-0">
                  <a class="hover-effect-underline stretched-link"
                    href="{{ url('listings-real-estate.html') }}">Philadelphia</a>
                </h3>
              </div>
              <div class="card-footer d-flex bg-transparent border-0 pt-0 pb-3 px-3 mt-n1">
                <div class="w-50 text-center pe-1">
          ...
          <article class="hover-effect-scale text-center">
            <div class="position-relative mb-3">
              <div class="ratio ratio-1x1 bg-body-secondary rounded-circle overflow-hidden mx-auto"
                style="width: 132px">
                <img src="{{ asset('frontend/assets/img/home/real-estate/agents/01.png') }}" class="hover-effect-target"
                  alt="Avatar">
              </div>
              <h3 class="h5 pt-3 mt-sm-1 mb-1">
                <a class="hover-effect-underline stretched-link" href="vendor-real-estate.html">Ivy Taylor</a>
              </h3>
        ...
        <div class="col mb-3">
          <article class="hover-effect-scale text-center">
            <div class="position-relative mb-3">
              <div class="ratio ratio-1x1 bg-body-secondary rounded-circle overflow-hidden mx-auto"
                style="width: 132px">
                <img src="{{ asset('frontend/assets/img/home/real-estate/agents/02.png') }}" class="hover-effect-target"
                  alt="Avatar">
              </div>
              <h3 class="h5 pt-3 mt-sm-1 mb-1">
                <a class="hover-effect-underline stretched-link" href="vendor-real-estate.html">Floyd Miles</a>
              </h3>
        ...
        <div class="col mb-3">
          <article class="hover-effect-scale text-center">
            <div class="position-relative mb-3">
              <div class="ratio ratio-1x1 bg-body-secondary rounded-circle overflow-hidden mx-auto"
                style="width: 132px">
                <img src="{{ asset('frontend/assets/img/home/real-estate/agents/03.png') }}" class="hover-effect-target"
                  alt="Avatar">
              </div>
              <h3 class="h5 pt-3 mt-sm-1 mb-1">
                <a class="hover-effect-underline stretched-link" href="{{ url('vendor-real-estate.html') }}">Adrian
                  Frederick</a>
              </h3>
        ...
        <div class="col mb-3">
          <article class="hover-effect-scale text-center">
            <div class="position-relative mb-3">
              <div class="ratio ratio-1x1 bg-body-secondary rounded-circle overflow-hidden mx-auto"
                style="width: 132px">
                <img src="{{ asset('frontend/assets/img/home/real-estate/agents/04.png') }}" class="hover-effect-target"
                  alt="Avatar">
              </div>
              <h3 class="h5 pt-3 mt-sm-1 mb-1">
                <a class="hover-effect-underline stretched-link" href="{{ url('vendor-real-estate.html') }}">Hugh
                  Blake</a>
              </h3>
            ...
            <div class="swiper-wrapper">
              ...
              <article class="swiper-slide">
                <a class="ratio d-flex hover-effect-scale rounded overflow-hidden mb-3 mb-sm-4"
                  href="{{ url('blog-single-v1.html') }}" style="--fn-aspect-ratio: calc(300 / 416 * 100%)">
                  <img src="{{ asset('frontend/assets/img/blog/v1/01.jpg') }}" class="hover-effect-target" alt="Image">
                </a>
                <div class="nav pb-1 mb-2">
                  <a class="nav-link text-body-secondary fs-xs text-uppercase p-0" href="#!">Renting advice</a>
                </div>
                <h3 class="h5 mb-2">
                  <a class="hover-effect-underline" href="{{ url('blog-single-v1.html') }}">What to know when renting an
                    apartment</a>
                </h3>
                <p class="fs-sm">
                  It is quite difficult to find a good apartment for long-term rent in large cities. In addition,
                  potential tenants can face prob...
                </p>
              ...
              <article class="swiper-slide">
                <a class="ratio d-flex hover-effect-scale rounded overflow-hidden mb-3 mb-sm-4"
                  href="{{ url('blog-single-v1.html') }}" style="--fn-aspect-ratio: calc(300 / 416 * 100%)">
                  <img src="{{ asset('frontend/assets/img/blog/v1/02.jpg') }}" class="hover-effect-target" alt="Image">
                </a>
                <div class="nav pb-1 mb-2">
                  <a class="nav-link text-body-secondary fs-xs text-uppercase p-0" href="#!">Investment advice</a>
                </div>
                <h3 class="h5 mb-2">
                  <a class="hover-effect-underline" href="{{ url('blog-single-v1.html') }}">Types of luxury housing</a>
                </h3>
                <p class="fs-sm">
                  What luxury housing is clear to every person. Housing characterized by increased comfort, interior,
                  quality and ma...
                </p>
                <div class="nav fs-sm gap-3">
              ...
              <article class="swiper-slide">
                <a class="ratio d-flex hover-effect-scale rounded overflow-hidden mb-3 mb-sm-4"
                  href="{{ url('blog-single-v1.html') }}" style="--fn-aspect-ratio: calc(300 / 416 * 100%)">
                  <img src="{{ asset('frontend/assets/img/blog/v1/03.jpg') }}" class="hover-effect-target" alt="Image">
                </a>
                <div class="nav pb-1 mb-2">
                  <a class="nav-link text-body-secondary fs-xs text-uppercase p-0" href="#!">Home improvement</a>
                </div>
                <h3 class="h5 mb-2">
                  <a class="hover-effect-underline" href="{{ url('blog-single-v1.html') }}">How to modernize your home
                    on a budget</a>
                </h3>
                <p class="fs-sm">Modernizing your home doesn't have to break the bank. Here are some budget-friendly
                  tips to give your living space a mo...</p>
                <div class="nav fs-sm gap-3">
  ...
  <!-- Page footer -->
@include('layouts.profile.partials.footer')
