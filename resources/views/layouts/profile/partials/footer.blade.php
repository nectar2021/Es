    ...
    <div class="container pt-sm-2 pt-md-3 pt-lg-4 pb-4">
      <div class="accordion row pb-4 pb-md-3 pb-lg-4 mb-2 mb-sm-3 mb-md-2" id="footerLinks">
        ...
        <div class="accordion-item col-sm-4 col-md-4 col-lg-3 border-0">
          ...
          <div class="accordion-collapse collapse d-sm-block" id="quickLinks" aria-labelledby="quickLinksHeading"
            ...
            <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
              ...
              <li class="pt-1">
                <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Long-term
                  rental</a>
              </li>
              <li class="pt-1">
        ...
        <div class="col-lg-4 col-xxl-3 pt-4 pt-md-5 pt-lg-0 mt-3 mt-md-0">
          <div
            class="d-flex flex-column flex-sm-row flex-lg-column align-items-center justify-content-between justify-content-lg-center text-center text-sm-start text-lg-center">
            <h6 class="h5 mb-sm-0 mb-lg-3 me-sm-3 me-md-4 me-lg-0">Get exclusive advice</h6>
            <button type="button" class="btn btn-lg btn-outline-secondary w-100" style="max-width: 205px">Sign
              up</button>
      ...
      <div class="position-relative d-flex flex-column flex-md-row align-items-center overflow-hidden mb-md-2">
        <div
          class="position-relative d-xl-flex align-items-center w-100 z-2 text-center text-md-start py-4 py-md-5 px-4 px-sm-5 ps-md-5 pe-md-0 pe-lg-5 pe-xl-0 mt-md-4 ms-xxl-3 me-lg-5 me-xl-0">
          <div class="pt-3 pt-md-0 pt-xl-2 pe-xl-2 pe-xxl-0 me-xl-4 me-xxl-5">
            <h3 class="mb-2">Download Finder App</h3>
            <p class="text-body-secondary mb-xl-0">Find everything you need for buying, selling and renting property in
              our new Finder App!</p>
          </div>
          <div
            class="d-flex flex-shrink-0 justify-content-center justify-content-md-start gap-3 pt-xl-3 pe-xl-3 me-xxl-5">
        ...
        <div class="bg-body-tertiary position-absolute bottom-0 start-0 w-100 rounded-4 d-none d-md-block"
      ...
      <div class="text-center pt-4 pb-md-2">
        <p class="text-body-secondary fs-sm mb-0">© All rights reserved. Made by <a
            class="text-body fw-medium text-decoration-none hover-effect-underline" href="https://createx.studio/"
            target="_blank" rel="noreferrer">Createx Studio</a></p>
      </div>
    </div>
  </footer>
